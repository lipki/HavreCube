...
public class EntityArrow extends Entity
{
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setBoolean("player", field_28020_a);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        field_28020_a = nbttagcompound.getBoolean("player");
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && field_28020_a && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1)))
        {
