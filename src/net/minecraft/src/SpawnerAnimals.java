...
public final class SpawnerAnimals
{
              ...
              if((!var38.getPeacefulCreature() || var2) && (var38.getPeacefulCreature() || var1) && var0.countEntities(var38.getCreatureClass()) <= var38.getMaxNumberOfCreature() * eligibleChunksForSpawning.size() / 256) {
                 ...
                 while(var39.hasNext()) {
                    ...
                    if(var12 != null && !var12.isEmpty()) {
                       ...
                       int var18 = var41.y;
                       int var19 = var41.z;
                       if(!var0.func_28100_h(var42, var18, var19) && var0.getBlockMaterial(var42, var18, var19) == var38.getCreatureMaterial()) {
                          int var20 = 0;
    ...
    private static boolean canCreatureTypeSpawnAtLocation(EnumCreatureType enumcreaturetype, World world, int i, int j, int k)
    {
        ...
        {
            return world.getBlockMaterial(i, j, k).getIsLiquid() && !world.func_28100_h(i, j + 1, k);
        } else
        {
            return world.func_28100_h(i, j - 1, k) && !world.func_28100_h(i, j, k) && !world.getBlockMaterial(i, j, k).getIsLiquid() && !world.func_28100_h(i, j + 1, k);
        }
    }
        ...
        do
        {
            ...
            if(aclass != null && aclass.length != 0)
            {
                ...
                while(i < 20 && !flag1) 
                {
                    ...
                    int j1;
                    for(j1 = l; j1 > 2 && !world.func_28100_h(j, j1 - 1, k); j1--) { }
