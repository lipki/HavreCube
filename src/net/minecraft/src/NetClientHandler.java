...
//            ItemStack, Packet23VehicleSpawn, EntityMinecart, Entity, 
//            EntityFish, EntityArrow, EntitySnowball, EntityFireball, 
//            EntityEgg, EntityBoat, EntityTNTPrimed, EntityFallingSand, 
//            Block, ModLoaderMp, World, ModLoader, 
//            EntityLiving, Packet71Weather, EntityLightningBolt, EntityPainting, 
...
//            ChunkCoordinates, Packet6SpawnPosition, WorldInfo, Packet39AttachEntity, 
//            Packet38EntityStatus, Packet8UpdateHealth, Packet9Respawn, Explosion, 
//            Packet60Explosion, Packet100OpenWindow, InventoryBasic, Container, 
//            TileEntityFurnace, TileEntityDispenser, MathHelper, Packet103SetSlot, 
//            Slot, Packet106Transaction, Packet104WindowItems, Packet130UpdateSign, 
//            TileEntitySign, TileEntity, Packet105UpdateProgressbar, Packet5PlayerInventory, 
//            Packet54PlayNoteBlock, Packet70Bed, Packet131MapData, Item, 
//            ItemMap, MapData, Packet61DoorChange, EntityClientPlayerMP, 
//            Packet200Statistic, Packet, Packet101CloseWindow
...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn packet23vehiclespawn)
    {
        ...
        Class class1 = ModLoaderMp.HandleNetClientHandlerEntities(packet23vehiclespawn.type);
        if(class1 != null)
        {
            try
            {
                obj = (Entity)class1.getConstructor(new Class[] {
            ...
            catch(Exception exception)
            {
                ...
                ModLoader.ThrowException(String.format("Error initializing entity of type {0}.", new Object[] {
    ...
    public void handleMobSpawn(Packet24MobSpawn packet24mobspawn)
    {
        ...
        int i = packet24mobspawn.type >= 0 ? ((int) (packet24mobspawn.type)) : packet24mobspawn.type + 256;
        EntityLiving entityliving = (EntityLiving)EntityList.createEntity(i, mc.theWorld);
