...
//            WorldChunkManager, BiomeGenBase, World, ChunkCoordIntPair

public class WorldChunkManagerHavreCube extends WorldChunkManager
{

    public WorldChunkManagerHavreCube(BiomeGenBase biomegenbase, double d, double d1)
    {
    ...
    public BiomeGenBase[] loadBlockGeneratorData(BiomeGenBase abiomegenbase[], int i, int j, int k, int l)
    {
        ...
        humidity = new double[100];
        Arrays.fill(abiomegenbase, 0, k * l, field_4201_e);
        Arrays.fill(humidity, 0, 100, field_4199_g);
        Arrays.fill(temperature, 0, 100, field_4200_f);
